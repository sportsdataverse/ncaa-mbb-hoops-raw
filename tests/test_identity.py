...
from ncaa_mbb_03_games_parse import parse_bundle
from ncaa_mbb_raw_scrape.ncaa_identity import (
    _key_name,
    _utf8_id,
    enrich_parsed,
    load_roster_index,
...
def _write_tree(
    ...
    *,
    ...
    """Materialize a {lg}/teams/json + {lg}/rosters/json tree, as ncaa_mbb_05_datasets_build writes it."""
